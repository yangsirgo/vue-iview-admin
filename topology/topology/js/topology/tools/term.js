...
(function() {
	...
	Terminal.colors = (function() {
		var colors = Terminal.colors, r = [0x00, 0x5f, 0x87, 0xaf, 0xd7, 0xff], i;
		// 16-231
		i = 0;
		for (; i < 216; i++) {
	...
	Terminal.bindKeys = function(flag) {
	...
	Terminal.prototype.write = function(data) {
		...
		for (; i < l; i++) {
			...
			case normal:
				...
				default:
					// ' '
//					console.log("this.x:"+this.x+"|| this.y:"+this.y+"====ch:"+ch)
//					console.log("this.cols:"+this.cols)
	...
	Terminal.prototype.charAttributes = function(params) {
		var l = params.length, i = 0, bg, fg, p;
