(function($) {
	...
	var u = navigator.userAgent.toLowerCase(),
		...
		b = m[1] || "",
		v = m[2] || 0,
		ie = b === "msie" || (b === "mozilla" && !! (u.match(/trident/) && (u.match(/rv 11/) || u.match(/rv:11/))));
	$.layout.browser = {
		version: v,
		safari: b === "webkit",
		webkit: b === "chrome",
	...
	$.fn.layout = function(opts) {
		var browser = $.layout.browser,
			...
			resizeAll = function(evt_or_refresh) {
				...
				var shrunkH = (sC.innerHeight < oldH),
...
(function(a) {
	...
	a.layout.state = {
		saveCookie: function(f, d, c) {
			var g = f.options,
				h = g.stateManagement,
				b = a.extend(true, {}, h.cookie, c || null),
		...
		readState: function(d, k) {
			...
			var v = d.options.stateManagement,
				o = k.includeChildren,
				b = o !== undefined ? o : v.includeChildren,
				l = k.stateKeys || v.stateKeys,
				w = {
					isClosed: "initClosed",
					isHidden: "initHidden"
				},
				e = d.state,
				j = a.layout.config.allPanes,
				x = {},
				q, m, y, z, r, t, f, h, g, c;
			if (a.isArray(l)) {
				l = l.join(",")
		...
		_create: function(c) {
			...
			a.extend(c, {
				...
				encodeJSON: b.encodeJSON,
				decodeJSON: b.decodeJSON
			});
			c.state.stateData = {};
			if (!i.autoLoad) {
				return
	...
	a.layout.browserZoom = {
		...
		_setTimer: function(d) {
			...
			var e = d.options,
				c = d.state,
				b = d.hasParentLayout ? 5000 : Math.max(e.browserZoomCheckInterval, 100);
			setTimeout(function() {
